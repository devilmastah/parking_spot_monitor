...
export FLASH_BEFORE_CAPTURE="$(bashio::config 'flash_before_capture' false)"
export PREPARE_CAPTURE_WAIT_MS="$(bashio::config 'prepare_capture_wait_ms' 3000)"
export SNAPSHOT_WARMUP_FRAMES="$(bashio::config 'snapshot_warmup_frames' 1)"
